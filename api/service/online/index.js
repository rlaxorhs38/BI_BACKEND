...
exports.getSaleByBrdDetailData = (req, res) => {
    ...
    sql += "                            CASE ";
    sql += "                                WHEN VDCD IN ('MI615', 'MID85', 'IT519', 'IT520', 'IT521', 'IN804', 'SO885')  ";
    sql += "                                THEN SILAMT ELSE 0  ";
    sql += "                            END JASASILAMT , ";
    sql += "                            CASE ";
    sql += "                                WHEN SUCD = '23' AND VDCD <> 'IN804'  ";
    sql += "                                            THEN SILAMT ELSE 0 ";
    sql += "                            END OUTSILAMT , ";
    sql += "                            CASE ";
    sql += "                                WHEN VDCD IN ('MI615', 'MID85', 'IT519', 'IT520', 'IT521', 'IN804', 'SO885') ";
...
exports.getDailySaleList = (req, res) => {
    ...
    sql += "                               SALEDT , ";
    sql += "                               CASE ";
    sql += "                                WHEN VDCD IN ('MI615', 'MID85', 'IT519', 'IT520', 'IT521', 'IN804', 'SO885') THEN SILAMT  ";
...
exports.getDailySaleList_POP = (req, res) => {
    ...
    sql += "                                     THEN SILAMT ";
    sql += "                                    END DAYJASA, ";
    sql += "                                    CASE WHEN SUCD = '23' AND    VDCD <> 'IN804' THEN SILAMT ";
    sql += "                                    END DAYOUT ";
    sql += "                             FROM   BION060 ";
    sql += "                             WHERE  SALEDT BETWEEN '" + start_date + "' AND '" + end_date + "' ";
    sql += "                             AND    CREATEDATE = (SELECT MAX(CREATEDATE) FROM   BION060) ) ";
